    ...
    tr.innerHTML = `
      ...
      <td>
        <div class="action-buttons">
          <button class="btn-action view-btn" data-id="${event.id}">
              <i class="fa-solid fa-eye"></i>
          </button>
          <button class="btn-action edit-btn" data-id="${event.id}">
              <i class="fa-solid fa-pen"></i>
          </button>
          <button class="btn-action delete-btn" data-id="${event.id}" data-title="${event.title.replace(/"/g, '&quot;')}">
